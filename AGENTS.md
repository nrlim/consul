...
**CONSUL** is an AI-powered platform for healthcare professionals. It provides deterministic audit klaim summarization and patient history validation. The product targets hospitals, clinics, and healthcare institutions that need standardized, auditable clinical workflows.
...
## 2. Audit Klaim Data Contract

**BEFORE** changing any of the following, read `docs/architecture-and-data-contract.md` **completely**:

- Audit Klaim logic or UI
