...
import WorkflowProgressModal, { ACTIVE_WORKFLOW_STORAGE_KEY } from '@/app/dashboard/claim-review/components/WorkflowProgressModal'
        ...
        {isNavVisible && (
          <aside className="sticky top-0 flex h-dvh w-56 shrink-0 flex-col border-r border-border bg-sidebar">
            <div className="flex h-14 items-center border-b border-border px-6">
              <Link href="/" className="flex items-center gap-[1px] px-2 py-4 group" aria-label="CONSUL Home">
              <ConsulLogoIcon className="h-6 w-auto transition-transform group-hover:scale-105" />
              <span className="text-xl font-bold tracking-tighter text-slate-900 font-logo pt-[2px]">ONSUL</span>
            </Link>
            </div>
            ...
            <nav className="flex-1 overflow-y-auto px-4 py-6 space-y-2" aria-label="Dashboard navigation">
              ...
              <div className="pt-2">
                ...
                {openMenus['Clinical Workflows'] && (
                  <div className="mt-1 space-y-1 pl-3 border-l border-border/50 ml-3">
                    <Link href="/dashboard/claim-review/ocr-import" className={`flex min-h-8 items-center rounded-md px-3 text-sm transition-colors ${pathname.startsWith('/dashboard/claim-review/ocr-import') ? 'bg-slate-100 text-primary font-medium' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-normal'}`}>OCR Import</Link>
                    <Link href="/dashboard/claim-review" className={`flex min-h-8 items-center rounded-md px-3 text-sm transition-colors ${pathname === '/dashboard/claim-review' || pathname.startsWith('/dashboard/claim-review/baru') || (pathname.match(/^\/dashboard\/claim-review\/[a-zA-Z0-9-]+$/) && !pathname.includes('ocr-import') && !pathname.includes('review')) ? 'bg-slate-100 text-primary font-medium' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-normal'}`}>Validasi Klaim</Link>
                    <Link href="/dashboard/claim-review/review" className={`flex min-h-8 items-center rounded-md px-3 text-sm transition-colors ${pathname.startsWith('/dashboard/claim-review/review') ? 'bg-slate-100 text-primary font-medium' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900 font-normal'}`}>Review Klaim</Link>
                  </div>
                )}
              </div>
            ...
            <div className="flex-1 overflow-y-auto px-5 pb-6 pt-2">
              ...
              <div>
                ...
                <nav className="grid grid-cols-4 gap-2 sm:gap-4">
                  ...
                  <Link href="/dashboard/claim-review/ocr-import" className="group flex flex-col items-center justify-start gap-2 rounded-xl p-2 transition-colors hover:bg-muted text-foreground">
                    <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-background border border-border shadow-sm group-hover:bg-card transition-all text-muted-foreground group-hover:text-primary">
                  ...
                  <Link href="/dashboard/claim-review" className="group flex flex-col items-center justify-start gap-2 rounded-xl p-2 transition-colors hover:bg-muted text-foreground">
                    <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-background border border-border shadow-sm group-hover:bg-card transition-all text-muted-foreground group-hover:text-primary">
                  ...
                  <Link href="/dashboard/claim-review/review" className="group flex flex-col items-center justify-start gap-2 rounded-xl p-2 transition-colors hover:bg-muted text-foreground">
                    <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-background border border-border shadow-sm group-hover:bg-card transition-all text-muted-foreground group-hover:text-primary">
