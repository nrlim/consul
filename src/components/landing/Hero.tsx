...
const metrics = [
  { value: "98%", label: "Akurasi OCR" },
  { value: "FWA", label: "Analisis Otomatis" },
  { value: "< 5s", label: "Ekstraksi per Dokumen" },
  { value: "Penuh", label: "Jejak Audit Keputusan" },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-20 items-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-light tracking-tight text-foreground leading-[1.1] mb-6">
              Kejernihan data.<br />
              <span className="font-semibold text-primary">Kepastian keputusan.</span>
            </h1>
            <p className="text-lg text-muted-foreground font-light mb-10 max-w-md">
              Tinggalkan audit klaim manual. Ekstrak data dari dokumen dengan AI OCR, dan deteksi Fraud, Waste, Abuse secara instan.
            </p>
              ...
              <div className="space-y-10 relative">
                ...
                <div className="relative flex gap-5 group">
                  ...
                  <div className="pt-1">
                    ...
                    <h3 className="text-base font-medium text-foreground mb-1.5">Ekstraksi AI OCR</h3>
                    <p className="text-sm text-muted-foreground font-light leading-relaxed">
                      Upload dokumen klaim (PDF/Gambar). Model Flux mengekstrak teks dan data terstruktur secara presisi tanpa intervensi manual.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex gap-5 group">
                  ...
                  <div className="pt-1">
                    ...
                    <h3 className="text-base font-medium text-foreground mb-1.5">Deteksi FWA & Validasi</h3>
                    <p className="text-sm text-muted-foreground font-light leading-relaxed">
                      Cross-reference data ekstraksi dengan Data Lake (Tarif, Klaim, PubMed). Mesin kami mendeteksi anomali Fraud, Waste, dan Abuse.
                    </p>
                  </div>
                </div>
                ...
                <div className="relative flex gap-5 group">
                  ...
                  <div className="pt-1">
                    ...
                    <h3 className="text-base font-medium text-foreground mb-1.5">Skoring & Keputusan</h3>
                    <p className="text-sm text-muted-foreground font-light leading-relaxed">
                      Dapatkan rekomendasi skor dan evidensi medis (Confidence & Evidence) untuk verifikasi human-in-the-loop yang lebih akurat.
                    </p>
                  </div>
                </div>
