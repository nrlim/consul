    ...
    <div className="space-y-6">
      <section className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="rounded-lg border border-border bg-card p-5 shadow-sm">
          ...
          <p className="mt-2 text-sm leading-6 text-muted-foreground">Kuota request berkurang 1 setiap validasi Audit Klaim atau AI mapping yang dijalankan client. Credit USD tetap dicatat sebagai biaya internal super admin.</p>
        </div>
      </section>
