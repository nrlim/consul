            ...
            <tbody className="divide-y divide-border">
              {paginatedItems.length === 0 ? (
                ...
                <tr key={item.id} className="transition-colors hover:bg-muted/40">
                  ...
                  <td className="px-5 py-4 text-center">
                    <Link href={`/dashboard/claim-review/review/${item.id}`} className="inline-flex min-h-9 items-center justify-center whitespace-nowrap text-center rounded-md bg-foreground px-4 py-2 text-[11px] font-medium uppercase tracking-wider text-background shadow-sm transition-colors hover:bg-foreground/90 focus:outline-none">
                      Buka Workbench
                    </Link>
                  </td>
                </tr>
