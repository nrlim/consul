  ...
  const renderStep8 = () => (
    <div className="space-y-6">
      ...
      <div className="rounded-lg bg-primary-soft/30 border border-primary/20 p-5 mt-8">
        ...
        <p className="text-sm text-text-subtle mb-4">Ensure all data in tabs 1 to 8 is correct. The AI Brain system will validate fees, drug prices, document completeness, and generate a standard audit klaim.</p>
      </div>
    </div>
  );
