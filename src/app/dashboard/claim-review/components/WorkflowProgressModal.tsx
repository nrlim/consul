...
const WORKFLOW_STEPS: WorkflowStepResult[] = [
  ...
  { stepId: "pathway-gen", label: "Generate Audit Klaim", description: "Menyusun standard audit klaim berdasarkan diagnosis...", status: "waiting", timestamp: "" },
      ...
      intervalRef.current = setInterval(async () => {
        ...
        try {
          ...
          if (data.status === "running") {
            ...
            markAllDone();
            setTimeout(() => {
              router.push(`/dashboard/claim-review/${jobId}`);
              router.refresh();
              onClose();
            }, 1200);
