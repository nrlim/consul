        ...
        <div className="grid gap-6 p-6 lg:grid-cols-[1.5fr_1fr] lg:p-8">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link href="/dashboard/claim-review" className="inline-flex min-h-11 items-center justify-center rounded-md bg-foreground px-5 py-2 text-sm font-medium text-background transition-colors hover:bg-foreground/90 focus:outline-none">
                Buka Audit Klaim
              </Link>
      ...
      <section className="grid grid-cols-1 gap-6 xl:grid-cols-[1fr_1.2fr]">
        ...
        <div className="rounded-xl border border-border bg-card shadow-sm flex flex-col">
          <div className="flex items-center justify-between gap-3 border-b border-border p-6">
            ...
            <Link href="/dashboard/claim-review" className="text-sm font-medium text-foreground hover:underline">Lihat semua →</Link>
          </div>
          <div className="divide-y divide-border">
            {recentJobs.length === 0 ? (
              ...
              return (
                <Link key={job.id} href={`/dashboard/claim-review/${job.id}`} className="block p-5 transition-colors hover:bg-muted group">
