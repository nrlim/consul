...
export const metadata: Metadata = {
  ...
  description: "Panduan integrasi API SnapPath untuk audit klaim dan validasi klaim. Autentikasi, endpoint, dan contoh request.",
};
...
export default function PublicApiDocsPage() {
                ...
                <div>
                  ...
                  <nav className="space-y-1">
                    {[
                      ...
                      { href: "#clinical-pathway", label: "Audit Klaim" },
            ...
            <div className="lg:col-span-2 space-y-12">
              ...
              <section id="overview">
                ...
                <p className="text-sm text-text-subtle leading-relaxed mb-4">
                  SnapPath menyediakan REST API berbasis JSON untuk mengintegrasikan fitur validasi klaim dan pembuatan audit klaim ke dalam sistem internal institusi Anda.
                </p>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    },
                    {
                      ...
                      desc: "Generate audit klaim berbasis ICD-10 dan jenis kunjungan",
                      color: "bg-blue-500/15 text-blue-400 border-blue-500/20",
                    },
                    {
                      method: "GET",
  ...
  "statusUrl": "/api/v1/jobs/{jobId}/status"
              ...
              <section id="clinical-pathway">
                <h2 className="text-2xl font-bold text-text mb-4">Audit Klaim</h2>
                <p className="text-sm text-text-subtle leading-relaxed mb-4">
                  Endpoint <code className="text-xs bg-surface-elevated px-1.5 py-0.5 rounded border border-border/50">POST /api/v1/pathways/generate</code> menghasilkan audit klaim klinis berbasis diagnosis.
                </p>
                <div className="rounded-xl border border-border/50 bg-surface-elevated overflow-hidden">
                  <div className="border-b border-border/50 bg-surface px-5 py-3">
